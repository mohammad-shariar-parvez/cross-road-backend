...
const initPayment = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = {
            ...
            currency: 'BDT',
            tran_id: (0, uuid_1.v4)(),
            success_url: 'https://msp-tutoring-service-server.vercel.app/api/v1/payments/success',
            fail_url: 'https://msp-tutoring-service-server.vercel.app/api/v1/payments/fail',
            cancel_url: 'https://msp-tutoring-service-server.vercel.app/api/v1/payments/cancel',
            ipn_url: 'https://msp-tutoring-service-server.vercel.app/api/v1/payments/ipn',
            shipping_method: 'N/A',
